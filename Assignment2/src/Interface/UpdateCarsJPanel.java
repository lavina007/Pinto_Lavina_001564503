 ...
 * @author Lavina
 */
public class UpdateCarsJPanel extends javax.swing.JPanel {
    ...
    UpdateCarsJPanel(JPanel userProcessContainer, UberCars uberCars, UberCarsDirectory uberCarsDirectory) {
        initComponents();
